...
두 파일에서 `YOUR_GITHUB_USERNAME`을 실제 GitHub 사용자명으로 교체:

```
web/index.html          → canonical URL, og:url, og:image
scripts/update_seo_meta.py → SITE_URL 변수
```
